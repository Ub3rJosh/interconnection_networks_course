...
#include "../incl/tr.evlst.h"

/**************************************************************************************\
****************************** EVENT LIST Operations ***********************************
****************************************************************************************
**                                                                                    **
**       There are two implementations of the eventlist: a calendar queue and         **
**       a simple linear list.  The choice of which list to use is determined         **
**       by a command line argument or by the operation EventListSelect().            **
**       The implementaton of the calendar queue algorithm follows the description    **
**       in "Calendar Queues: A Fast O(1) Priority Queue Implementation for the       **
**       Simulation Event Set Problem," by Randy Brown, Comm. ACM, Oct. 1988,         **
**       pp. 1220-1227.
**                                                                                    **
****************************************************************************************
\**************************************************************************************/
...
static ACTIVITY *next;                /* Pointer to the element after this one        */
...
{
   /* Note that this routine must be called before anything else uses the event list  */
   /* Moreover, there is no check of this of warning to the user if it happens        */
